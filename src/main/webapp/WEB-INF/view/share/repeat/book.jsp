...
<head>
    ...
    <title>${book.name } - kidbridge</title>
        ...
        <div class="top-applink">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <a class="btn-app-open J_ota" href="${header['user-agent'].toLowerCase().contains("iphone") or header['user-agent'].toLowerCase().contains("mac") ? "https://itunes.apple.com/cn/app/hs%E8%8B%B1%E6%96%87%E7%BB%98%E6%9C%AC%E8%AF%BE%E5%A0%82/id1297122816?mt=8" : "http://www.baidu.com" }" target="_blank">下载</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="repeat">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body book-outline">
                        ${empty book.outline ? "暂无内容" : book.outline }
                    </div>
                </div>
                <div class="panel panel-default">
