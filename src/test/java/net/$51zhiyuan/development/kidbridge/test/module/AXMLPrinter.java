...
public class AXMLPrinter {
	...
	public static void main(String[] arguments) throws XmlPullParserException, IOException {
		AXmlResourceParser parser=new AXmlResourceParser();
		parser.open(new FileInputStream("C:\\Users\\Spring\\Desktop\\app-release\\AndroidManifest.xml"));
			...
			switch (type) {
				...
				case XmlPullParser.START_TAG:
				{
					...
					for (int i=0;i!=parser.getAttributeCount();++i) {
						result.append(String.format("%s%s%s=\"%s\"",indent,
