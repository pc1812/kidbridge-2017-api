...
public class VersionControllerTest {
    ...
    private final String domain = "http://127.0.0.1:83/version";
    ...
    @Test
    public void check() throws IOException, CertificateException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException, KeyStoreException {
        String api = "/check";
